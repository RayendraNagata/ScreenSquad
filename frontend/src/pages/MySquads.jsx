      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-4xl font-bold text-gray-900 mb-2 flex items-center">
                <svg className="w-10 h-10 mr-3 text-blue-600" fill="currentColor" viewBox="0 0 20 20">
        ...
        >
          <Card className="p-6 text-center">
            <div className="text-3xl font-bold text-squad-primary-600 mb-2">{stats.total}</div>
            <div className="text-gray-600">Total Squads</div>
          </Card>
          <Card className="p-6 text-center">
          ...
          <Card className="p-6 text-center">
            <div className="text-3xl font-bold text-blue-600 mb-2">{stats.isHost}</div>
            <div className="text-gray-600">You're Host</div>
          </Card>
        </motion.div>
            ...
            {[
              ...
              <button
                ...
                className={`px-6 py-3 rounded-lg font-medium transition-colors ${
                  filter === tab.key
                    ? 'bg-squad-primary-600 text-white'
                    ...
                    <div className="p-6 border-b border-gray-100">
                      <div className="flex items-start justify-between">
                        <div className="flex-1">
                          <h3 className="text-xl font-bold text-gray-800 mb-2 group-hover:text-squad-primary-600 transition-colors">
                            {squad.name}
                          </h3>
                        ...
                        <div className="flex flex-col items-end space-y-2">
                          ...
                          <div className={`px-3 py-1 rounded-full text-xs font-medium flex items-center ${
                            ...
                            <div className={`w-2 h-2 rounded-full mr-2 ${
                              squad.isActive ? 'bg-green-500' : 'bg-gray-500'
                            }`} />
                    ...
                    <div className="p-6">
                      ...
                      <div className="flex items-center space-x-3 mb-4">
                        <div className="flex -space-x-2">
                          {squad.members?.slice(0, 5).map((member, i) => (
                            <div 
                              key={member.id}
                              className="w-8 h-8 bg-gradient-to-r from-squad-primary-400 to-squad-secondary-400 rounded-full flex items-center justify-center text-white text-sm font-medium border-2 border-white"
                          ...
                          {squad.members?.length > 5 && (
                            <div className="w-8 h-8 bg-gray-200 rounded-full flex items-center justify-center text-xs font-semibold text-gray-600 border-2 border-white">
                              +{squad.members.length - 5}
                            </div>
                          )}
                        </div>
                      ...
                      <div className="flex space-x-3">
                        <Button
                          ...
                          className="flex-1 bg-squad-primary-600 hover:bg-squad-primary-700 text-white text-sm py-2"
                        >
                          📺 Join Squad
                        </Button>
                        {squad.members?.some(m => m.username === 'You' && m.isHost) && (
